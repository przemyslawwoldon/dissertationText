...
\begin{document}
	...
	\addcontentsline{toc}{section}{Streszczenie}
         ...
         Słowa kluczowe: Detekcja nut, OpenCV, Przetwarzanie obrazów, Konwolucyjne Sieci Neuronowe, Tesseract OCR
	\section*{Abstract}
    ...
    The thesis associates two major part: partical and theoretical.
    The theoretical part describes the selected technologies which 
    (lub that) were used in system. The programming language used in which the application was created was Java
    (lub The utilized programing language was Java), 
    which determined the choice of the framework for artificial neural networks - Deeplearning4J. Other technologies that have been used in the system are OpenCV,
    used for digital image processing (lub which was used for digital image processing) and the Tesseract OCR system. The combination of these components and ensuring their appropriate cooperation enabled the correct operation of the application. The practical part clearly presents the implementation details of the algorithms. (lub The practical part in transparent way introduce the implementation details of the algorithm.) In the summary, the author critically recapitulates the work executed, draws attention to the advantages and disadvantages of the developed solution, at the same time giving ways to solve the problems and indicates the way of project development.
	...
	\section{Wykorzystane technologie}
		...
		\subsubsection{Zarys historyczny \cite{1}}
			\hspace{\spacingIndent} Prace nad budową tej biblioteki rozpoczął jeden z pracowników firmy Intel -- Gary Rost Bradski, 
				...
				darmowej infrastruktury pozwalającej na pracę, tak aby nie trzeba było ponownie "wynajdywać koła". \cite{1}
